        ...
        <Layout className="pt-2 md:pt-16 sm:pt-8">
          <div className="flex items-center justify-between w-full lg:flex-col ">
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              ...
              />
              <AnimatedText
                text={t(LANGUAGE.mern_developer)}
                fontColour="!text-yellow-500"
                className="!text-6xl !text-left xl:!text-5xl lg:!text-center lg:!text-6xl md:!text-5xl sm:!text-3xl"
              />
              <ul className="my-4 text-base font-medium md:text-sm sm:text-xs ">
                <li className="m-1">{t(LANGUAGE.home_1)}</li>
                <li className="m-1">{t(LANGUAGE.home_2)}</li>
                <li className="m-1">{t(LANGUAGE.home_3)}</li>
              </ul>
              <div className="flex flex-wrap  items-center self-start mt-2 lg:self-center">
                ...
                >
                  {t(LANGUAGE.projects)} <GoProject className="ml-2" />
                </Link>
              </div>
